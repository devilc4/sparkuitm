...
<head>
  ...
  <title> UiTM SPARK SYSTEM | NEW ARRIVED </title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-9">
            <h1 class="m-0">NEW ARRIVED PARCEL</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="container-md">
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped" style="font-size: 13px;margin-left:-9px;">
                    <thead>
                    <tr>
                    <th>NO.</th>
                    <th>TRACKING NO</th>
